...
const AddVendor = () => {
  ...
  const confirmPasswordInputHandler = e =>{
    ...
    if (!CommonMethods.passwordValidator(cpass)) {
      setErrors({ ...errors, confirmPassword : "Please enter valid confirm password"  });
    } else {
      if (cpass != pass) {
        setErrors({ ...errors, confirmPassword : "Password & Confirm Password doesn't match"  });
      } else {
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-6">
                              <div className="mb-4">
                                ...
                                <input type={ passShown ? "text" : "password" } className="form-control passwoprd-field" 
                                name="password" id="password" placeholder="Password" onChange={handleFormFieldsChange} onInput={passwordInputHandler} />
                                <a className="input-group-append input-group-text password-div">
                                    <i className={ passShown ? "bi-eye" : "bi-eye-slash" } onClick={handlepassword} id="passIcon"></i>
                                </a>
                            ...
                            <div className="col-sm-6">
                              <div className="mb-4">
                                ...
                                <div className="input-group input-group-merge">
                                  <input type={ confrmpassShown ? "text" : "password" } className="form-control" name="confirmPassword" id="confirmPassword"
                                  ...
                                  <a className="input-group-append input-group-text">
                                    <i className={ confrmpassShown ? "bi-eye" : "bi-eye-slash" } onClick={handleconfirmpassword} id="passIcon1"></i>
                                  </a>
                                </div>
                            ...
                            <div className="col-sm-6">
                              <div className="mb-4">
                                ...
                                <input type="text" className="form-control" name="companyName" id="companyName"
                                  placeholder="Company Name" onChange={handleFormFieldsChange} />
                            ...
                            <div className="col-sm-6">
                              <div className="mb-4">
                                ...
                                <input type="text" className="form-control" name="companyGSTIN" id="companyGSTIN"
                                  placeholder="Company GSTIN" onChange={handleFormFieldsChange} />
                            ...
                            <div className="col-sm-6">
                              <div className="mb-4">
                                ...
                                <input type="text" className="form-control" name="companyWebsiteURL" id="companyWebsiteURL"
                                  placeholder="Company Website URL" onChange={handleFormFieldsChange} />
                              ...
                              <div className="mb-4">
                                ...
                                <div className="tom-select-custom">
                                  <select className="js-select form-select tomselected" name="companyState"
                                    id="companyState" onChange={handleFormFieldsChange} >
