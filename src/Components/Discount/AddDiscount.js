                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb breadcrumb-no-gutter">
                                            <li className="breadcrumb-item">
                                                <Link className="breadcrumb-link" to="/discounts">Discount</Link>
                                            </li>
                                            <li className="breadcrumb-item active" aria-current="page">Add Discount</li>
                                        </ol>
                                    </nav>

                                    <h1 className="page-header-title">Add Discounts</h1>
                                </div>
                            ...
                            <div className='col-lg-12 mb-3 mb-lg-0'>
                                <div className="card mb-3 mb-lg-5">
                                    ...
                                    <div className="card-header">
                                        <h4 className="card-header-title">Discount information</h4>
                                    </div>
